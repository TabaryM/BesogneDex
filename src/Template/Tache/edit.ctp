...
<div class="container" style="margin-top: 50px;">
        ...
        <div class="row">
            ...
            <div class="col text-center" style="margin-top:20px;"><?= $this->Html->link("Retour", array('controller' => 'Tache', 'action'=> 'index',0), array( 'class' => 'btn btn-primary')); ?></div>
            <div class="col text-center" style="margin-top: 20px;"><?= $this->Form->submit('Modifier la tâche', array('class' => 'btn btn-primary')); ?></div>
        </div>
    </div>
